...
Notes:<br> 
For the CM4 non EMMC also called CM4 Lite, this is not needed from what i read, as it supports the conventional Raspberry Pi configuration via PI Imager and USB Boot option. THe CM4 EMMC needs this to be configured the "hardcoded way".
