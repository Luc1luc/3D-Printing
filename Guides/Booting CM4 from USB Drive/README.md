...
**Eeprom update and boot order**

```
cd ~/usbboot/recovery
rm -f pieeprom.original.bin
curl -L -o pieeprom.original.bin [[link to the recent/desired firmware.bin](https://github.com/raspberrypi/rpi-eeprom/tree/master)]
./update-pieeprom.sh
```
